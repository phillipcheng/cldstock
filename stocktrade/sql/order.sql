...
create table StockPosition(symbol varchar(50), orderqty decimal(10,2), orderprice decimal(10,2), buySubmitDt DATETIME, buyOrderId varchar(50), stopSellOrderId varchar(50), limitSellOrderId varchar(50), bsName varchar(100), soMap varchar(2000), primary key (buyOrderId));
